...
import { Check, Trash2, Edit3, Tag, Image as ImageIcon, Search } from 'lucide-react';
                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="border-b border-slate-50">
                            ...
                            <th className="px-6 py-6 text-[11px] font-black text-slate-400 uppercase tracking-widest text-right pr-10">Aksi</th>
                        </tr>
                    </thead>
                            ...
                            <tr key={item.id} className={`group hover:bg-slate-50/50 transition-all ${item.selected ? 'bg-emerald-50/30' : ''}`}>
                                ...
                                <td className="px-6 py-5 text-right pr-6">
                                    <button
                                        ...
                                        className="p-2 text-slate-300 hover:text-emerald-500 transition-colors bg-slate-50 rounded-xl"
                                    >
                                        <Edit3 size={18} />
                                    </button>
                                </td>
